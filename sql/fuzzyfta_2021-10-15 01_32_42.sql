...
-- Tábla adatainak mentése fuzzyfta.elements: ~3 rows (hozzávetőleg)
DELETE FROM `elements`;
/*!40000 ALTER TABLE `elements` DISABLE KEYS */;
INSERT INTO `elements` (`id`, `event_id`) VALUES
	(1, 1),
	(3, 2),
	(4, 2),
	(2, 3),
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='events table';

-- Tábla adatainak mentése fuzzyfta.events: ~6 rows (hozzávetőleg)
DELETE FROM `events`;
...
INSERT INTO `events` (`id`, `description`, `value`) VALUES
	...
	(4, '"Radiation is over sensor limit"', 0.5),
	(5, '"Radiation sensor is not connected"', 0.5),
	(6, '"Radiation sample is missing"', 0.5);
...
CREATE TABLE IF NOT EXISTS `relations` (
  ...
  `logicgate` enum('or','and') DEFAULT 'and',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- Tábla adatainak mentése fuzzyfta.relations: ~2 rows (hozzávetőleg)
